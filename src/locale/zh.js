var zh = {
    ...
    untag_tips: "untag或transparent模式下无需重复添加",
    ...
    device_type: "设备类型",
    file_size: "升级文件大小",
    upgrade_state: "当前升级状态",
    bytes_transmitted: "已经传输字节数",
    upgrade_status: "ONT当前升级状态",
    onu_upgrade_status: "ONT升级状态",
    upgrade_progress: "下载进度",
    start_upgrade: "开始升级",
    cancel_upgrade: "取消升级",
    select_ont_file: "选择厂商提供的ONT升级文件",
    ont_upgrade_succ_msg: "文件上传成功，具体升级状态请在ONT升级状态页查看",
    clear_select: "清除选中 ",
    lic_available: "剩余有效期",
    lic_total: "有效期",
    forever: "永久",
