<template>
    <div>
        ...
        <el-table :data="showList" border>
            <el-table-column :label="$lang('svp_af_id')" prop="svp_af_id"></el-table-column>
            ...
            <el-table-column :label="$lang('user_vlan')" prop="user_vlan">
                <template slot-scope="scope">{{ scope.row.user_vlan || '-' }}</template>
            </el-table-column>
        ...
        <el-dialog :visible.sync="dialogVisible" width="640px">
            ...
            <add-vp-from-af-form ref="add-vp-from-af-form"></add-vp-from-af-form>
            <div slot="footer">
