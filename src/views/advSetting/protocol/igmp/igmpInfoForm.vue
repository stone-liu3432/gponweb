<template>
    <el-form :model="form" label-width="200px" :rules="rules" ref="igmp-info-form">
        ...
        <template v-if="form.mode !== 0">
            ...
            <template v-if="form.mode === 1">
                <el-form-item :label="$lang('group_aging_time')" prop="group_aging_time">
            ...
            <template v-if="form.mode === 2">
                ...
                <el-form-item :label="$lang('gen_response_time')" prop="gen_response_time">
                    <el-input v-model.number="form.gen_response_time"></el-input>
                </el-form-item>
                <el-form-item :label="$lang('gen_query_interval')" prop="gen_query_interval">
                    <el-input v-model.number="form.gen_query_interval"></el-input>
                </el-form-item>
                <el-form-item :label="$lang('sp_response_time')" prop="sp_response_time">
                    <el-input v-model.number="form.sp_response_time"></el-input>
                </el-form-item>
                <el-form-item :label="$lang('sp_query_interval')" prop="sp_query_interval">
                    <el-input v-model.number="form.sp_query_interval"></el-input>
                </el-form-item>
                <el-form-item :label="$lang('sp_query_number')" prop="sp_query_number">
