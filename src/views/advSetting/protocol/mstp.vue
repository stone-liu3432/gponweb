<template>
    <div>
        ...
        <div class="mstp-global-status">
            ...
            <span>{{ SWITCH_MAP[mstp_status] }}</span>
            <el-button type="primary" size="small" @click="changeMstpState">{{
                $lang(BUTTON_TEXT[mstp_status])
            }}</el-button>
        </div>
