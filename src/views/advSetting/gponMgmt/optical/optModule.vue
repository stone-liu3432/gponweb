<template>
    <div>
        <el-row :gutter="20">
            ...
            <el-col :span="12">
                <opt-card :data="manuInfoData" title="o_m_maunu_info"></opt-card>
            </el-col>
        </el-row>
        <el-row :gutter="20" style="margin-top: 20px;">
            <el-col :span="12">
                <opt-card :data="staticInfoData" title="o_m_static_info"></opt-card>
            </el-col>
            <el-col :span="12">
                <opt-card :data="opParamData" title="o_m_threshold" :layout="[16, 8]"></opt-card>
            </el-col>
        </el-row>
    </div>
</template>
